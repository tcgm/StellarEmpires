...
// Usage: node parse_traits.js inputfile.txt [outputfile.json]
const [,, inputFile, outputFile] = process.argv;

if (!inputFile) {
    console.error('Usage: node parse_traits.js inputfile.txt [outputfile.json]');
    process.exit(1);
}
...
fs.writeFileSync('commonTraits.json', JSON.stringify(result, null, 2));
